...
from routes.dependencies import get_current_user, get_current_user_optional, build_user_public, resolve_actor
...
async def search_users(
    ...
    if q:
        ...
        try:
            ...
            blocked_ids = await get_blocked_user_ids(current_user.user_id)
        except Exception:
            pass
