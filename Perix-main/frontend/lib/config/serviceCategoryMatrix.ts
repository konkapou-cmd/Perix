...
export const SERVICE_CATEGORY_MATRIX: Record<string, ServiceCategoryAttachment> = {
  ...
  "sports-fitness-wellness": {
    ...
    questions: [
      ...
      { field: "visits_included", importance: "optional", labelKey: "services.visitsIncluded", fallbackLabel: "Besuche", icon: "footsteps", showOnCard: true },
      { field: "valid_days", importance: "optional", labelKey: "services.validDays", fallbackLabel: "Gültig (Tage)", icon: "calendar", showOnCard: true },
    ],
  ...
  "food-dining": {
    ...
    questions: [
      ...
      { field: "duration_minutes", importance: "optional", labelKey: "services.duration", fallbackLabel: "Dauer (min)", icon: "time", showOnCard: true, showOnDetail: true },
      { field: "capacity", importance: "optional", labelKey: "services.capacity", fallbackLabel: "Plätze", icon: "people", showOnCard: true },
  ...
  "local-hotels": {
    ...
    questions: [
      ...
      { field: "inventory_count", importance: "required", labelKey: "services.inventoryCount", fallbackLabel: "Number of rooms", icon: "layers", showOnCard: false, showOnDetail: true },
      { field: "max_adults", importance: "recommended", labelKey: "services.maxAdults", fallbackLabel: "Max adults per room", icon: "person", showOnCard: false, showOnDetail: true },
      { field: "max_children", importance: "optional", labelKey: "services.maxChildren", fallbackLabel: "Max children per room", icon: "people", showOnCard: false, showOnDetail: true },
      { field: "check_in_time", importance: "recommended", labelKey: "services.checkInTime", fallbackLabel: "Check-in time", icon: "time", showOnCard: false, showOnDetail: true },
      { field: "check_out_time", importance: "recommended", labelKey: "services.checkOutTime", fallbackLabel: "Check-out time", icon: "time", showOnCard: false, showOnDetail: true },
      { field: "min_nights", importance: "recommended", labelKey: "services.minNights", fallbackLabel: "Min nights", icon: "moon", showOnCard: false, showOnDetail: true },
      { field: "max_nights", importance: "recommended", labelKey: "services.maxNights", fallbackLabel: "Max nights", icon: "moon", showOnCard: false, showOnDetail: true },
      { field: "cancellation_policy", importance: "optional", labelKey: "services.cancellationPolicy", fallbackLabel: "Cancellation policy", icon: "document-text", showOnCard: false, showOnDetail: true },
      { field: "currency", importance: "recommended", labelKey: "services.currency", fallbackLabel: "Currency", icon: "cash", showOnCard: false, showOnDetail: false },
    ],
