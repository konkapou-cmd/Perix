...
const s = StyleSheet.create({
  ...
  planCard: { borderRadius: BORDER_RADIUS.lg, padding: SPACING.xl, marginBottom: SPACING.lg },
  planHeader: { flexDirection: "row", alignItems: "center", gap: SPACING.lg },
  planInfo: { flex: 1 },
  planLabel: { fontSize: FONT_SIZES.caption, fontWeight: FONT_WEIGHTS.semibold as any, marginBottom: SPACING.xs },
  planBadgeRow: { flexDirection: "row", alignItems: "center", gap: SPACING.sm },
  planBadge: { paddingHorizontal: SPACING.md, paddingVertical: SPACING.xs, borderRadius: BORDER_RADIUS.full },
  ...
  sectionCard: { borderRadius: BORDER_RADIUS.lg, padding: SPACING.xl, marginBottom: SPACING.lg },
  ssTitle: { fontSize: FONT_SIZES.body, fontWeight: FONT_WEIGHTS.semibold as any, marginBottom: SPACING.lg },
  featuresGrid: { gap: SPACING.lg },
  ...
  featureTextWrap: { flex: 1, paddingTop: SPACING.xs },
  ...
  benefitText: { fontSize: FONT_SIZES.bodySmall, color: COLORS.textSecondary, lineHeight: 22, marginBottom: SPACING.xs, paddingLeft: SPACING.lg },
  voucherRow: { flexDirection: "row", gap: SPACING.sm },
  voucherInput: { flex: 1, borderWidth: 1, borderColor: COLORS.border, borderRadius: BORDER_RADIUS.md, paddingHorizontal: SPACING.md, paddingVertical: SPACING.mdLg, fontSize: FONT_SIZES.body, color: COLORS.textPrimary, backgroundColor: COLORS.backgroundPage },
  voucherBtn: { backgroundColor: COLORS.primary, borderRadius: BORDER_RADIUS.md, paddingHorizontal: SPACING.xl, justifyContent: "center", alignItems: "center" },
  ...
  upgradeCard: { flexDirection: "row", alignItems: "center", gap: SPACING.lg, borderRadius: BORDER_RADIUS.lg, padding: SPACING.xl, marginBottom: SPACING.lg, borderWidth: 1, borderColor: COLORS.border, borderStyle: "dashed" },
  upgradeInfo: { flex: 1 },
