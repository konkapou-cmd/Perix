...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: FONT_SIZES.body, fontWeight: "600", color: COLORS.textPrimary, marginBottom: SPACING.md },
  reactionsRow: { flexDirection: "row", flexWrap: "wrap", gap: SPACING.md },
  reactionChip: {
  ...
  timeline: { flexDirection: "row", alignItems: "flex-end", gap: SPACING.sm, height: 120, paddingTop: 20 },
  ...
  viewerAvatar: { width: 36, height: 36, borderRadius: 18, marginRight: SPACING.md },
