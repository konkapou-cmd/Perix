...
const DEFAULT_LAYOUT: HomeLayoutConfig = {
  sections: [
    ...
    { id: "rentals", title: "Rentals", enabled: true, order: 8, layout: "carousel", customStyle: {} },
    { id: "marketplace", title: "Marketplace", enabled: true, order: 9, layout: "carousel", customStyle: {} },
    { id: "homes-nearby", title: "Homes Nearby", enabled: true, order: 10, layout: "carousel", customStyle: {} },
