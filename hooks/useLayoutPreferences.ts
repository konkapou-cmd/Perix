...
const DEFAULT_LAYOUT: HomeLayoutConfig = {
  sections: [
    ...
    { id: "rentals", title: "Rental & Real Estate", enabled: true, order: 7, layout: "carousel", customStyle: {} },
    { id: "jobs", title: "Jobs", enabled: true, order: 8, layout: "carousel", customStyle: {} },
    { id: "posts", title: "Latest Posts", enabled: true, order: 9, layout: "list", customStyle: {} },
  ],
  favoriteCategories: [],
