...
export const SERVICE_CATEGORY_MATRIX: Record<string, ServiceCategoryAttachment> = {
  ...
  "local-hotels": {
    ...
    icon: "bed",
    questions: [
      { field: "name", importance: "required", labelKey: "services.name", fallbackLabel: "Room/Unit", icon: "text", showOnCard: true, showOnDetail: true },
      { field: "type", importance: "required", labelKey: "services.serviceType", fallbackLabel: "Type", icon: "options", showOnCard: true, showOnDetail: true },
      ...
      { field: "max_guests", importance: "recommended", labelKey: "services.maxGuests", fallbackLabel: "Max Guests", icon: "people", showOnCard: true, showOnDetail: true },
      ...
      { field: "available_from", importance: "optional", labelKey: "services.availableFrom", fallbackLabel: "Available From", icon: "calendar", showOnCard: true },
